...
export var SToolTipContainer = styled.div(
   templateObject_1 ||
...
export var SToolTip = styled.div(
   templateObject_3 ||
   ...
   onlineTheme.font.size.smallMedium2,
   function(_a) {
      var side = _a.side;
      return css(
         templateObject_2 ||
...
export var Triangular = styled.div(
   templateObject_5 ||
...
export var ToolTipTitle = styled.div(
   templateObject_6 ||
