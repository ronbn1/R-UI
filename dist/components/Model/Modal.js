...
var Modal = function (_a) {
    var children = _a.children, body = _a.body, title = _a.title, color = _a.color, button = _a.button, onClickButton = _a.onClickButton, _b = _a.size, size = _b === void 0 ? Sizes.MEDIUM : _b, _c = _a.buttonPosition, buttonPosition = _c === void 0 ? Position.CENTER : _c;
    var _d = useState(false), isModalShow = _d[0], setIsModalShow = _d[1];
    var _e = useState(false), fadeOut = _e[0], setFadeOut = _e[1];
    useEffect(function () {
        if (fadeOut) {
            setTimeout(function () {
                setFadeOut(false);
    ...
    return (React.createElement(React.Fragment, null,
        ...
        isModalShow && (React.createElement(React.Fragment, null,
            ...
            React.createElement(SModal, { size: size, show: isModalShow, isFadeOut: fadeOut },
                ...
                React.createElement(SBody, null, typeof body === "object" ? (body.map(function (b) { return React.createElement("p", { className: "text" }, b); })) : (React.createElement("p", { className: "text" }, body))),
