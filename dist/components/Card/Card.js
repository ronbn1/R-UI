...
import { SBody, SSubtitle, STitle, SCard, SText, SLinkContainer, STopIcon, } from "./style";
import Button from "../Button/Button";
var Card = function (_a) {
    var children = _a.children, width = _a.width, _b = _a.style, style = _b === void 0 ? {} : _b;
    return (React.createElement(SCard, { width: width, style: __assign({}, style) },
...
var Title = function (_a) {
    ...
    return (React.createElement(STitle, { size: size, color: color, style: __assign({}, style) }, children));
};
