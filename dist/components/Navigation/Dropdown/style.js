...
export var SToggle = styled.p(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n   display: flex;\n   color: ", ";\n   cursor: pointer;\n   width: fit-content;\n\n   .iconContainer {\n      padding: 0 0.5rem;\n   }\n"], ["\n   display: flex;\n   color: ", ";\n   cursor: pointer;\n   width: fit-content;\n\n   .iconContainer {\n      padding: 0 0.5rem;\n   }\n"])), function (_a) {
    var color = _a.color;
...
export var SItem = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n   padding: 0.5rem 1rem;\n   color: ", ";\n   font-family: ", ";\n   font-size: 0.9rem;\n   &:hover {\n      cursor: pointer;\n      background-color: #eeeeee60;\n   }\n"], ["\n   padding: 0.5rem 1rem;\n   color: ", ";\n   font-family: ", ";\n   font-size: 0.9rem;\n   &:hover {\n      cursor: pointer;\n      background-color: #eeeeee60;\n   }\n"])), function (_a) {
    var color = _a.color;
    return color && onlineTheme.colors[color];
